...
const (
	...
	PREWAR_TEST_COUNT          = 8
	TARGET_SRV_MS_DEFAULT    = 5.0 // target srv (ms setelah T=0) untuk dynamic lead
...
var (
	...
	SKIP_USER_PATTERNS = []string{
		...
		"role_null", "role null", "invalid user", "user not found",
		"user_not_found", "act_subscrip_no_config", "subscrip_no_config",
	}
